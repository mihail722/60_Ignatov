...
int main(int argc, char* argv[])
{
    ...
    // Считать входной файл, в случае ошибки завершить работу программы
    if (!readInputFile(argv[1], line))
    {
        return 1;
    }
    ...
    // Сформировать выходной файл, в случае ошибки завершить работу программы и удалить корень дерева
    if (!saveGraph(argv[2], root))
    {
        delete root;
        return 1;
    }
...
{
    ofstream output(filename); // Считать выходной файл
